...
export const metadata: Metadata = {
  ...
  description: 'Kebijakan privasi dan perlindungan data pribadi di BPR Cakradana.',
};
        ...
        <div className="prose prose-slate max-w-none">
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 text-slate-700 space-y-2">
              ...
              <li>Informasi yang diperlukan untuk pembukaan rekening dan/atau pengajuan kredit</li>
              <li>Komunikasi antara Anda dan institusi kami</li>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 text-slate-700 space-y-2">
              <li>Memberikan produk dan layanan perbankan yang Anda minta</li>
              <li>Berkomunikasi dengan Anda tentang layanan kami</li>
              <li>Memproses pembayaran</li>
              <li>Mematuhi kewajiban hukum/regulasi perbankan</li>
            </ul>
          </section>

          <section className="mb-8">
            <h2 className="text-2xl font-bold text-slate-900 mb-4">3. Kerahasiaan Nasabah</h2>
            <p className="text-slate-700">
              Sebagai institusi perbankan, kami berkomitmen menjaga kerahasiaan data nasabah.
              Semua informasi yang Anda bagikan dengan kami akan dijaga kerahasiaannya sesuai dengan standar dan regulasi perbankan yang berlaku.
            </p>
          </section>
