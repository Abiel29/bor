...
const transportationOptions = [
  {
    icon: Car,
    title: 'Dengan Mobil',
    description: 'Parkir tersedia di basement gedung. Akses mudah dari Jalan Sudirman.',
    color: 'bg-blue-500'
  },
  {
    icon: Train,
    title: 'Transportasi Umum',
    description: 'MRT Bundaran HI (5 menit jalan kaki), TransJakarta Halte Dukuh Atas.',
    color: 'bg-green-500'
  },
  {
    icon: Navigation,
    title: 'Ojek Online',
    description: 'Gunakan landmark "Gedung Sudirman Plaza" untuk memudahkan driver.',
    color: 'bg-orange-500'
  }
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          >
            ...
            <Card className="border-0 shadow-lg">
              <CardContent className="p-6">
                <div className="flex items-start space-x-3 mb-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-slate-900 mb-2">Alamat Lengkap</h3>
            ...
            <div className="space-y-4">
              <h3 className="font-semibold text-slate-900">Cara Menuju Kantor</h3>
            ...
            <Card className="border-0 shadow-lg bg-blue-50">
              <CardContent className="p-6">
                <h3 className="font-semibold text-blue-900 mb-2">Kunjungan Kantor</h3>
                <p className="text-blue-700 text-sm mb-4">
                  Untuk kunjungan ke kantor, kami sarankan membuat janji terlebih dahulu 
                  untuk memastikan ketersediaan tim yang tepat.
                </p>
                <Button 
                  asChild 
                  size="sm" 
