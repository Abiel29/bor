            ...
            <div className="space-y-4">
              ...
              >
                ...
                <div>
                  ...
                  <div className="text-blue-100 text-sm">{firmInfo.whatsapp_number}</div>
                </div>
              </a>
              ...
              >
                ...
                <div>
                  ...
                  <div className="text-blue-100 text-sm">{firmInfo.phone}</div>
                </div>
              </a>
              ...
              <div className="flex items-center space-x-4 p-4 bg-white/10 rounded-lg">
                ...
                <div>
                  ...
                  <div className="text-blue-100 text-sm">{firmInfo.operation_hours}</div>
                </div>
              </div>
            </div>
          </motion.div>
